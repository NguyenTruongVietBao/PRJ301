                        ...
                        <div class="panel-body p-3">
                            <form action="MainController" method="POST" >
                                <div class="form-group py-2">
                                    <div class="input-field"> <span class="far fa-user p-2"></span> <input type="text" name="userID" placeholder="Username or Email" required> </div>
                                </div>
                                ...
                                <input type="submit" name="action" value="Login" class="btn btn-primary btn-block mt-3">Login
